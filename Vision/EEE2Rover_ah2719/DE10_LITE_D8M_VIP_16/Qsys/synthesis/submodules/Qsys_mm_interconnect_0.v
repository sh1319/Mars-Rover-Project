...
module Qsys_mm_interconnect_0 (
	...
	wire         cmd_mux_015_src_valid;                                                            // cmd_mux_015:src_valid -> uart_s1_agent:cp_valid
	wire  [96:0] cmd_mux_015_src_data;                                                             // cmd_mux_015:src_data -> uart_s1_agent:cp_data
	wire         cmd_mux_015_src_ready;                                                            // uart_s1_agent:cp_ready -> cmd_mux_015:src_ready
	wire  [15:0] cmd_mux_015_src_channel;                                                          // cmd_mux_015:src_channel -> uart_s1_agent:cp_channel
	wire         cmd_mux_015_src_startofpacket;                                                    // cmd_mux_015:src_startofpacket -> uart_s1_agent:cp_startofpacket
	wire         cmd_mux_015_src_endofpacket;                                                      // cmd_mux_015:src_endofpacket -> uart_s1_agent:cp_endofpacket
	...
	wire  [96:0] uart_s1_agent_rp_data;                                                            // uart_s1_agent:rp_data -> router_017:sink_data
	...
	wire         uart_s1_agent_rdata_fifo_src_valid;                                               // uart_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_015:in_0_valid
	wire  [33:0] uart_s1_agent_rdata_fifo_src_data;                                                // uart_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_015:in_0_data
	wire         uart_s1_agent_rdata_fifo_src_ready;                                               // avalon_st_adapter_015:in_0_ready -> uart_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_015_out_0_valid;                                                // avalon_st_adapter_015:out_0_valid -> uart_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_015_out_0_data;                                                 // avalon_st_adapter_015:out_0_data -> uart_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_015_out_0_ready;                                                // uart_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_015:out_0_ready
	wire   [0:0] avalon_st_adapter_015_out_0_error;                                                // avalon_st_adapter_015:out_0_error -> uart_s1_agent:rdata_fifo_sink_error
